...
class ContactsPermissionRequester(fragment: Fragment, onGranted: () -> Unit, onDenied: () -> Unit) : BasePermissionRequester(fragment, onGranted, onDenied) {

    override val permissions: Array<String> = arrayOf(Manifest.permission.READ_CONTACTS, Manifest.permission.WRITE_CONTACTS)
